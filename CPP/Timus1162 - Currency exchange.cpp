/*
  ...
  Если значение в изначальной вершине увеличилось, то значит, после некоторых обменов Ник смог получить больше изначальной валюты

  Также возможно, что для увеличения капитала нужно невероятно много операций, которые высчитывать будет слишком долго.
  Вместо этого, по лемме, если после [N - 1] итераций цикла Форда-Беллмана значение в какой либо вершине будет увеличиваться и последующих циклах, 
  то можно сказать, что в графе суцествует положительный цикл, а значит, капитал приумножить можно
*/
